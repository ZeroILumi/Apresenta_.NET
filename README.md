...
# Apresentação Pratica de C#:
  * ## Lista de Assuntos tratados nesse projeto:
    1. 1 [x] Instalando ou Atualizando o SDK do .NET.   
    2. 2 [x] Verificando qual a versão do .NET esta sendo utilizada.
	3. 3 [x] Instalando ou Atualizando(por fora nesse caso) nossa IDE(Integrated Development Environment) o Visual Studio Code.
	4. 4 [x] Instalando a Extensão/Plug-in Portuguese (Brazil) Language Pack for Visual Studio Code para deixar o Visual Studio Code em Português do Brasil.
	5. 5 [x] Instalando a Extensão/Plug-in "C#" para permitir a utilização de códigos C# no Visual Studio Code.
	6. 6 [x] Instalando a Extensão/Plug-in "C# Extensions" do Autor "jchannon" para facilitar o trabalha com "C#" no Visual Studio Code.
##  Assunto de número(1):
